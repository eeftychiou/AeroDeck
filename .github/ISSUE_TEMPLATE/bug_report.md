...
## Is this a AeroDeck issue or a platform issue?
<!-- AeroDeck is a plugin. Some reported "bugs" are actually issues
     in the underlying platform or model. If you're not sure, try
     reproducing without AeroDeck installed.

     If the problem persists without AeroDeck, file the issue with
     your platform instead. -->

- [ ] I confirmed this issue does not occur without AeroDeck installed
