...
<!-- AeroDeck core contains general-purpose skills and infrastructure
...
<!-- If this PR adds support for a new harness (IDE, CLI tool, agent
     ...
     A real integration loads the `using-aerodeck` bootstrap at session
...
- [ ] If this is a skills change: I used `aerodeck:writing-skills` and
