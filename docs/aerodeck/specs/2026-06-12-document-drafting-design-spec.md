# Design Specification: Document Drafting Skill

**Date:** 2026-06-12  
**Status:** Approved  
**Topic:** `document-drafting` Skill  

## Triggering Conditions

* **Name:** `document-drafting`
* **Triggering Description:** Use when creating, rewriting, or editing reports, executive summaries, emails, cover letters, instructions, or structured document files.

## Core Phases & Workflow

### Phase 1: Audience & Tone Profiling
Before drafting, the assistant must analyze the target reader and select the appropriate tone profile:
...
The final drafting must be executed directly by the **main agent** (to leverage full active conversation context and user alignment). The assistant drafts the content according to the type of document:
...
After drafting, the assistant must verify the output against this edit checklist:
