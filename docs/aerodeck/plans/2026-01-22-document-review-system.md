...
> **For agentic workers:** REQUIRED: Use aerodeck:subagent-driven-development (if subagents available) or aerodeck:executing-plans to implement this plan.
...
**Spec:** docs/aerodeck/specs/2026-01-22-document-review-system-design.md
...
**Dispatch after:** Spec document is written to docs/aerodeck/specs/
...
```markdown
> **For agentic workers:** REQUIRED: Use aerodeck:subagent-driven-development (if subagents available) or aerodeck:executing-plans to implement this plan. Tasks and steps use checkbox (`- [ ]`) syntax for tracking.
```
