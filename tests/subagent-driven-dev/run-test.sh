...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/aerodeck
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/aerodeck-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using aerodeck:subagent-driven-development. The plan is at: $PLAN_PATH"
